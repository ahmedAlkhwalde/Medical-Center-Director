...
const ScheduleFilters = ({
  searchQuery,
  onSearchChange,
  selectedSpecialty, // يمثل الآن الـ id الرقمي
  onSpecialtyChange,
  onResetFilters,
  specialties = [] // نمرر هنا قائمة الاختصاصات بـ id و name من الـ API الخاص بها
}) => {
    ...
    >
      <div className="rounded-4xl theme-surface-90 p-5 md:p-6">
        <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="text-sm theme-text-muted">
              يتم الفلترة بالاختصاص مباشرة من الخادم (Server-side).
            </p>
          </div>
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.4fr)_minmax(260px,0.8fr)]">
          ...
          {/* حقل اختيار الاختصاص المعتمد على الـ ID الرقمي الصريح */}
          <label className="block">
            ...
            <div className="relative rounded-3xl border theme-border theme-surface-95">
              <select
                ...
                className="w-full appearance-none rounded-3xl border-0 bg-transparent py-3 pr-4 pl-12 text-sm theme-text outline-none cursor-pointer"
              >
                {/* تم تعيين كلاس الثيم هنا وهنا بالأسفل لإجبار القائمة المنسدلة على دعم الـ Dark Mode */}
                <option value="" className="theme-surface theme-text">
                  كل الاختصاصات
                </option>
