...
//               إدارة معلومات حسابك الشخصي وتحديثها بسهولة.
//             </p>
//           </div>
//           {!isEditing && (
//             <Motion.button
...
//       <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
//         {/* بطاقة الصورة - ستأخذ ارتفاع النموذج بالكامل */}
...
//                     className="absolute bottom-0 right-0 bg-teal-500 text-white p-2 rounded-full shadow-lg hover:bg-teal-600 transition-colors cursor-pointer"
//                   >
...
//                   onChange={handleChange}
//                   disabled={!isEditing}
//                   className="w-full rounded-xl border theme-border theme-surface px-4 py-2.5 text-sm theme-text outline-none disabled:opacity-60"
//                 />
//               </div>
//               <div>
//                 <label className="flex items-center gap-2 text-sm font-semibold theme-text mb-2">
...
//                   className="rounded-xl border theme-border theme-surface px-6 py-2.5 text-sm font-semibold theme-text cursor-pointer"
//                 >
//                   إلغاء
//                 </button>
//                 <button
//                   type="submit"
//                   disabled={isUpdating}
//                   className="flex cursor-pointer items-center gap-2 rounded-xl theme-accent px-6 py-2.5 text-sm font-bold theme-text-on-accent shadow-md disabled:opacity-50"
//                 >
//                   {isUpdating ? (
//                     <>
