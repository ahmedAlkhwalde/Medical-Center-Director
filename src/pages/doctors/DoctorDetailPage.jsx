...
import TrendPill from "../../features/dashboard/components/TrendPill";
import { formatNumber } from "../../features/dashboard/store/dashboardSlice";
...
const DoctorDetailPage = () => {
  ...
  const {
    ...
    isLoading,
    error,
  } = useDoctorStatisticsQuery(doctorId, queryParams);
  ...
  const displayDoctorName =
    passedDoctorName || apiData?.data?.doctor_info?.name || "الطبيب";
