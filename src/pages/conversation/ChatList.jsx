              ...
              >
                ...
                <div className="flex-1 min-w-0 space-y-0.5">
                  <div className="flex items-center gap-2">
                    <h3
                      className={`text-sm tracking-wide truncate ${isCurrentlySelected ? "font-black text-teal-500" : "font-bold theme-text"}`}
                    >
                      {chat.name}
                    </h3>
                ...
                <div className="flex flex-col items-end justify-between h-10 text-left flex-shrink-0">
                  <span
                    className={`text-[10px] font-semibold ${isCurrentlySelected ? "text-teal-500" : "text-gray-400 dark:text-gray-500"}`}
                  >
                    {chat.time}
                  </span>
